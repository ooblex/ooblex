...
class DemoController:
    ...
    async def start_demo_stream(self, stream_id="demo", source="0"):
        ...
        await self.channel.default_exchange.publish(message, routing_key="video_decode")
    ...
    async def process_frames(self, stream_id="demo", effect="style_transfer"):
        ...
        frame_exchange = await self.channel.declare_exchange(
            ...
            async for message in queue_iter:
                async with message.process():
                    ...
                    await self.channel.default_exchange.publish(
                        task_message, routing_key="tasks"
                    )
            ...
            for key in keys:
                ...
                if frame_data:
                    ...
                    await self.redis.publish(
                        f"processed_frames:{stream_id}", frame_data
                    )
    ...
    async def create_test_pattern(self):
        ...
        cv2.rectangle(
            frame, (width // 2, height // 2), (width, height), (255, 255, 0), -1
        )
