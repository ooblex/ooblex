...
class TracingConfig:
    ...
    def setup_metrics(self, prometheus_port: int = 9090):
        ...
        self.meter_provider = MeterProvider(
            resource=self.resource, metric_readers=[prometheus_reader]
        )
...
class MetricsCollector:
    ...
    def record_duration(
        self, name: str, duration_ms: float, attributes: Optional[Dict[str, Any]] = None
    ):
...
def setup_service_tracing(
    service_name: str, enable_console: bool = False
) -> TracingConfig:
