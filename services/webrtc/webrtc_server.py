...
class VideoTransformTrack(MediaStreamTrack):
    ...
    def __init__(self, track: MediaStreamTrack, peer_id: str, redis_client: redis.Redis):
        super().__init__()
        self.track = track
        ...
        try:
            ...
            if self.frame_count % FRAME_SAMPLE_RATE == 0:
                ...
                if queue_length < MAX_QUEUE_SIZE:
                    await self.redis_client.lpush(FRAME_QUEUE_KEY, json.dumps(frame_data))
...
class WebRTCConnection:
    ...
    async def on_track(self, track: MediaStreamTrack):
        ...
        if track.kind == "video":
            ...
            transform_track = VideoTransformTrack(track, self.peer_id, self.redis_client)
...
async def main():
    ...
    try:
        ...
        try:
            ...
            ssl_context.load_cert_chain('/mnt/c/Users/steve/Code/claude/ooblex/ssl/server.crt',
        ...
        logger.info(f"WebRTC server started on port 8443 (HTTPS: {ssl_context is not None})")
