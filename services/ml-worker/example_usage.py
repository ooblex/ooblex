...
async def submit_ml_task(
    channel, redis_client, stream_token, process_type, parameters=None
):
    ...
    # Publish to RabbitMQ
    message = Message(json.dumps(task_data).encode(), delivery_mode=2)  # Persistent
