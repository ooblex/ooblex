...
# Metrics
frames_processed = Counter('ml_frames_processed_total', 'Total frames processed', ['worker_id', 'process_type'])
processing_time = Histogram('ml_frame_processing_seconds', 'Frame processing time', ['process_type'])
...
def process_frame_worker(frame_data: Dict[str, Any], model_path: str) -> Optional[Dict[str, Any]]:
