...
class TestAPIIntegration:
    ...
    async def test_process_workflow(self, api_client, redis_client, rabbitmq_connection):
    ...
    async def test_health_check_with_dependencies(self, api_client, redis_client, rabbitmq_connection):
